...
class OpenAILLMAdapter:
    ...
    def _chat(self, user_content: str, system: str = "") -> str:
        ...
        try:
            ...
            logger.error("LLM | OpenAI request failed: %s", e)
    ...
    def classify(self, message: str) -> ClassificationResult:
        ...
        for attempt in range(_MAX_RETRIES + 1):
            user_content = (
                ...
                else _RETRY_TEMPLATE.format(error=error_context, message=message)
            )
            try:
                raw = self._chat(user_content, system=_CLASSIFY_SYSTEM)
